    ...
    init:function () {
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Additive Name', name:'name', width:300, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'empty', defval:''}},
                {display:'Product Used For', name:'product_type_id', width:170, sortable:true, align:'left', hide:false, editable:{form:'select', validate:'', defval:'', bclass:'product_type_id-class', options:products}}
            ],
