            ...
            switch ($type) {
                case 'get' :
                   ...
                   /* $contain = array(
                    ...
                    $data_table = $this->OmcCustomerSalesProduct->find('all', array('conditions' => $condition_array,'order' => "OmcCustomerSalesProduct.$sortname $sortorder", 'page' => $page  , 'limit'=> $limit, 'recursive' => 1));
