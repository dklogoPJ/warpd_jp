...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'rates/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'rates/save')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'rates/delete')); ?>" />
<input type="hidden" id="table-export-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'export_rates')); ?>" />
