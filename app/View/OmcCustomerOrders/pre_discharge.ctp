        ...
        <div class="span3">
            ...
            <div class="block-fluid">
                ...
                <div class="footer tal">
                    ...
                    <?php echo $this->Form->input('export_url', array('type'=>'hidden','id'=>'export_url', 'value'=> $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'export_pre_discharge')))); ?>
