...
<!-- URL  to dynamically get in flow from post discharge table -->
<input type="hidden" id="post_discharge_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'get_post_discharge_details')); ?>" />
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_customer/temperature_compesation.js');
?>
