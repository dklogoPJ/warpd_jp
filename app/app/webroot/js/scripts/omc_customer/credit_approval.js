...
//       btn_actions.push({type:'select',name: 'Select Customer To View Ledger', id: 'filter_status',bclass: 'filter',onchange:self.handleGridEvent,options:customer_name_lists});
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Request Quantity (ltr)', name:'sales_qty', width:140, sortable:false, align:'left', hide:false, editable:{form:'text', validate:'', defval:'', on_key_up:'{"action":"multiply", "sources":["sales_qty","price"], "targets":["sales_amount"]}'}},
                ...
                {display:'Request Sales Amount (GHs.)', name:'sales_amount', width:180, sortable:true, align:'left',format_number:true, hide:false, editable:{form:'text',readonly:'readonly', validate:'', defval:''}},
