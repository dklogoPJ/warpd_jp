       ...
       // btn_actions.push({type:'select',name: 'Order Status', id: 'filter_status',bclass: 'filter',onchange:self.handleGridEvent,options:order_filter});
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Dipping Post-Discharge (ltr)', name:'dipping_post_discharge', width:170, sortable:true, align:'left', hide:false},
                {display:'Received Qty (ltr)', name:'received_quantity', width:150, sortable:true, align:'left', hide:false},
                {display:'Discharge Date', name:'discharge_date', width:120, sortable:false, align:'left', hide:false},
