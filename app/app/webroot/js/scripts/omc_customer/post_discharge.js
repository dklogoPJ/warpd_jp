       ...
       // btn_actions.push({type:'select',name: 'Order Status', id: 'filter_status',bclass: 'filter',onchange:self.handleGridEvent,options:order_filter});
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Product Density Depot', name:'product_density', width:150, sortable:true, align:'left', hide:false},
                {display:'Product Temp-Depot', name:'product_temp_depot', width:130, sortable:true, align:'left', hide:false},
                {display:'Product Density Station', name:'product_density_st', width:150, sortable:true, align:'left', hide:false},
