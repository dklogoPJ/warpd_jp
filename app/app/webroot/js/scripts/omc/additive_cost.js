    ...
    init:function () {
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'ID', name:'id', width:20, sortable:true, align:'left', hide:true},
                {display:'Order Id', name:'order_id', width:80, sortable:true, align:'left', hide:false},
                {display:'Order Date', name:'order_date', width:100, sortable:true, align:'left', hide:false},
                {display:'Customer Name', name:'omc_customer_id', width:180, sortable:true, align:'left', hide:false},
                {display:'Loading Depot', name:'depot_id', width:170, sortable:true, align:'left', hide:false},
                {display:'Product Type', name:'product_type_id', width:180, sortable:true, align:'left', hide:false}, 
                {display:'Truck No.', name:'truck_no', width:120, sortable:true, align:'left', hide:false}, 
                {display:'Loading Quantity', name:'loading_quantity', width:120, sortable:true, align:'left', hide:false, editable:{form:'text',readonly:'readonly', validate:'empty', defval:''}}, 
                {display:'Loading Date', name:'loading_date', width:100, sortable:true, align:'left', hide:false},
