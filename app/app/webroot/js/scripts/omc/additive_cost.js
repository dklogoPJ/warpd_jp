    ...
    init:function () {
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Customer Name', name:'customer', width:180, sortable:true, align:'left', hide:false,  editable:{form:'select', validate:'', defval:'', bclass:'product_type_id-class', options:customerLists}},
                {display:'Loading Depot', name:'loading_depot', width:170, sortable:true, align:'left', hide:false, editable:{form:'select', validate:'', defval:'', bclass:'product_type_id-class', options:depotLists}},
                ...
                {display:'Doping Ratio', name:'doping_ratio', width:120, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'empty', defval:''}}, 
                {display:'Additive Quantity (Ltrs)', name:'additive_quantity', width:150, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'empty', defval:''}}, 
                {display:'Additive Cost Per Ltr', name:'additive_cost_ltr', width:150, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'empty', defval:''}}, 
                {display:'Invoice Additive Cost', name:'invoice_additive_cost', width:150, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'empty', defval:''}}
            ],
