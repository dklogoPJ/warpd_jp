       ...
       // btn_actions.push({type:'select',name: 'Filter Rate Category', id: 'filter_category' ,bclass: 'filter',onchange:self.handleGridEvent,options:filter_rate_cats});
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Name', name:'omc_customer_id', width:250, sortable:true, align:'center', hide:false, editable:{form:'select', readonly:'readonly', validate:'', defval:'',options:customer}},
