var OmcOrder = {
    ...
    init: function () {
        ...
        var col_models = [
            ...
            {display: 'Loaded Quantity', name: 'loaded_quantity', width: 130, sortable: true, align: 'left', hide: false},
            {display:'Loading Date', name:'loaded_date', width:80, sortable:false, align:'left', hide:false},
            {display: 'Received Quantity', name: 'received_quantity', width: 130, sortable: true, align: 'left', hide: false},
            {display: 'GIT Status', name: 'git_status', width: 110, sortable: true, align: 'left', hide: false}
        ];
