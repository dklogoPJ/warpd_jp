<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">NCTs Validation <small> Dashboard</small></h1>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <div class="head clearfix">
                ...
                <h1>NCTs Validation Input Table</h1>
            </div>
...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'nct_validations/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'nct_validations/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'nct_validations/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'nct_validations/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'nct_validations/delete')); ?>" />
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc/nct_validation.js');
?>
