...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">RM Performance Monitoring Analytics  <small> Dashboard</small></h1>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <div class="head clearfix">
                ...
                <h1>Performance Monitoring Analytics Table</h1>
            </div>
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_performance/performance_analytics.js');
?>
