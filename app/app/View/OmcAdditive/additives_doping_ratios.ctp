...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Additive Doping Ratios  <small> Dashboard</small></h1>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <div class="head clearfix">
                ...
                <h1>Additive Doping Ratios Table</h1>
            </div>
        ...
        <div class="span3">
            ...
            <div class="block-fluid">
                ...
                <div class="footer tal">
                    ...
                    <?php echo $this->Form->input('export_url', array('type'=>'hidden','id'=>'export_url', 'value'=> $this->Html->url(array('controller' => 'OmcAdditive', 'action' => 'export_doping_ratio')))); ?>
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc/additive_ratio.js');
?>
