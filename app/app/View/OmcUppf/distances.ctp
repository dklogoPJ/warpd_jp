...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'distances/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'distances/save')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'distances/delete')); ?>" />
<input type="hidden" id="table-export-url" value="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'export_distances')); ?>" />
