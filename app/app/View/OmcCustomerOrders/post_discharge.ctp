<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Post Discharge <small> Dashboard</small></h1>
    </div>
        ...
        <div class="span3">
            ...
            <div class="block-fluid">
                ...
                <div class="footer tal">
                    ...
                    <?php echo $this->Form->input('export_url', array('type'=>'hidden','id'=>'export_url', 'value'=> $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'export_post_discharge')))); ?>
...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'post_discharge/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'post_discharge/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'post_discharge/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'post_discharge/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'post_discharge/delete')); ?>" />
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_customer/post_discharge.js');
?>
